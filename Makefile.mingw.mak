...
AUTO_TAG_GEN_CFLAGS = -W -Wall -DBUILD_DLL -DBUILDING_DLL -D_WINDLL -Wall -Wextra \
	-pedantic -fopenmp -O -O1 -O2 -O3 -O4 -Os -fexpensive-optimizations -m32 \
	$(CPPFLAGS) $(CFLAGS)
...
auto_tag_gen.dll: $(AUTO_TAG_GEN_OBJECTS)
	$(CC) $(LINK_DLL_FLAGS) -fPIC -o $@ $(AUTO_TAG_GEN_OBJECTS)  -Wl,--out-implib=libauto_tag_gen.a -mwindows -s -mwindows -m32 -s $(LDFLAGS)  -luser32 -lkernel32 -lshell32 -lgdi32 -lcomctl32 -lole32  -m32
